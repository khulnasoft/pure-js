...
var BANNER = '\u001B[96mThank you for using pure-javascript (\u001B[94m https://github.com/khulnasoft/pure-javascript \u001B[96m) for polyfilling JavaScript standard library!\u001B[0m\n\n' +
             '\u001B[96mThe project needs your help! Please consider supporting pure-javascript:\u001B[0m\n' +
             '\u001B[96m>\u001B[94m https://opencollective.com/pure-javascript \u001B[0m\n' +
             '\u001B[96m>\u001B[94m https://patreon.com/khulnasoft \u001B[0m\n' +
             '\u001B[96m>\u001B[94m https://boosty.to/khulnasoft \u001B[0m\n' +
             '\u001B[96mI highly recommend reading this:\u001B[94m https://github.com/khulnasoft/pure-javascript/blob/master/docs/2023-02-14-so-whats-next.md \u001B[96m\u001B[0m\n';
...
function isBannerRequired() {
  ...
  var file = path.join(os.tmpdir(), 'pure-javascript-banners');
  var banners = [];
  try {
